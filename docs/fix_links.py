...
def replace_links(html_file_path, replacement):
    ...
    updated_content, count1 = re.subn(r'action="search.html"', f'action="{replacement}search.html"', content)

    # Replace the second pattern for header links
    updated_content, count2 = re.subn(r'<a class="top-button" href="\./', f'<a class="top-button" href="{replacement}', updated_content)
    updated_content, count3 = re.subn(r'<a href="./home.html">', f'<a href="{replacement}home.html">', updated_content)
