...
If you already have a Vertica database running and want to use the QueryProfiler tool 
to analyze your query, you can install VerticaPyLab independently to achieve this. 
