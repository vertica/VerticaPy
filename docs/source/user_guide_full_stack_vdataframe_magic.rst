...
VerticaPy 0.3.2 introduces the 'Magic' methods, which offer some additional flexilibility for mathematical operations in the :py:func:`~verticapy.vDataFrame`. These methods let you handle many operations in a 'pandas-like' or Pythonic style.
...
You can easily apply Vertica functions to your :py:func:`~verticapy.vDataFrame`. Here, we use Vertica's COALESCE function to impute the 'age' of the passengers in our dataset.
...
You can now slice the :py:func:`~verticapy.vDataFrame` with indexing operators.
