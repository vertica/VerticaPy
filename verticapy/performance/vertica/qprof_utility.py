...
class QprofUtility:
    ...
    def _get_metrics_name(metric: str, inv: bool = False) -> str:
        look_up_table = {
            ...
            "join_inner_clock_time_us": "AVG Join inner clock time per node in \u00b5s",
            "join_inner_exec_time_us": "AVG Join inner execution time per node in \u00b5s",
            "join_outer_clock_time_us": "AVG Join outer clock time per node in \u00b5s",
            "join_outer_exec_time_us": "AVG Join outer execution time per node in \u00b5s",
            "network_wait_us": "AVG Network wait time per node in \u00b5s",
            "producer_stall_us": "AVG Producer stall time per node in \u00b5s",
            "producer_wait_us": "AVG Producer wait time per node in \u00b5s",
            "request_wait_us": "AVG Request wait time per node in \u00b5s",
            "response_wait_us": "AVG Response wait time per node in \u00b5s",
            "recv_net_time_us": "AVG Recv net time per node in \u00b5s",
            "recv_wait_us": "AVG Recv wait time per node in \u00b5s",
