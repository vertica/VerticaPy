...
@pytest.fixture(name="plot_result_multiplot", scope="class")
def load_plot_result_multiplot(dummy_dist_vd):
    """
...
class TestMatplotlibVDCDensityPlot:
    """
    ...
    @pytest.fixture(autouse=True)
    def multi_plot_result(self, plot_result_multiplot):
        """
        Get the plot results for multi-plot
        """
...
class TestMatplotlibVDFDensityPlot:
    """
