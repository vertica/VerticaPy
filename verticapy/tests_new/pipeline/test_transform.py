...
class TestTransform:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("ema", "age", None, {"name": "asc", "ticket": "desc"}, "new_colm",
            ...
            ("last_value", "age", "home.dest", {"name": "asc", "ticket": "desc"}, "new_colm"),
    ...
    def test_polynomial_comb(self, columns, r):
        ...
        unique_combinations = set(tuple(sorted(c, key=elements.index)) for c in combinations)
