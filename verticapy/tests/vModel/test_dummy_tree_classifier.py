...
def model(base, dtc_data_vd):
    ...
    base.cursor.execute("SELECT rf_classifier('decision_tc_model_test', 'public.dtc_data', 'TransPortation', '*' USING PARAMETERS exclude_columns='id, TransPortation', mtry=4, ntree=1, max_breadth=1e9, sampling_size=1, max_depth=100, nbins=1000, seed=1, id_column='id')")
...
class TestDummyTreeClassifier:
    ...
    def test_drop(self, base):
        ...
        model_test = DummyTreeClassifier("decision_tc_model_test_drop", cursor=base.cursor)
    ...
    @pytest.mark.skip(reason="Model Conversion for DummyTreeClassifier is not yet supported.")
