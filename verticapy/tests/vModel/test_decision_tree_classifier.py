...
def dtc_data_vd(base):
    ...
    base.cursor.execute("INSERT INTO dtc_data VALUES (2, 'Bus', 'Male', 1, 'Cheap', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (3, 'Train', 'Female', 1, 'Cheap', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (4, 'Bus', 'Female', 0, 'Cheap', 'Low')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (5, 'Bus', 'Male', 1, 'Cheap', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (6, 'Train', 'Male', 0, 'Standard', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (7, 'Train', 'Female', 1, 'Standard', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (8, 'Car', 'Female', 1, 'Expensive', 'Hig')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (9, 'Car', 'Male', 2, 'Expensive', 'Med')")
    base.cursor.execute("INSERT INTO dtc_data VALUES (10, 'Car', 'Female', 2, 'Expensive', 'Hig')")
...
def model(base, dtc_data_vd):
    ...
    base.cursor.execute("SELECT rf_classifier('decision_tc_model_test', 'public.dtc_data', 'TransPortation', '*' USING PARAMETERS exclude_columns='id, TransPortation', mtry=4, ntree=1, max_breadth=100, sampling_size=1, max_depth=6, nbins=40, seed=1, id_column='id')")

    # I could use load_model but it is buggy
    model_class = DecisionTreeClassifier("decision_tc_model_test", cursor=base.cursor,
                                         max_features = 4, max_leaf_nodes = 100,
...
class TestDecisionTreeClassifier:
    ...
    def test_drop(self, base):
        ...
        model_test = DecisionTreeClassifier("decision_tc_model_test_drop", cursor=base.cursor)
        model_test.fit("public.dtc_data",
    ...
    @pytest.mark.skip(reason="Model Conversion for DecisionTreeClassifier is not yet supported.")
