...
def rfc_data_vd(base):
    ...
    with warnings.catch_warnings(record=True) as w:
        drop(name="public.rfc_data", cursor=base.cursor)
...
class TestRFC:
    ...
    def test_contour(self, base, titanic_vd):
        model_test = RandomForestClassifier("model_contour", cursor=base.cursor)
        model_test.drop()
        model_test.fit(
            titanic_vd,
            ["age", "fare",],
    ...
    @pytest.mark.skip(
        reason="Model Conversion for RandomForestClassifier is not yet supported."
    )
    ...
    def test_to_python(self, model, titanic_vd):
        model_test = RandomForestClassifier("rfc_python_test", cursor=model.cursor)
        model_test.drop()
    ...
    def test_to_graphviz(self, model):
        ...
        assert gvz_tree_1 == 'digraph Tree{\ngraph [rankdir = "LR"];\n0 [label="\\"cost\\"", shape="box", style="filled"]\n0 -> 1 [label="= Expensive", color="blue"]\n0 -> 2 [label="!= Expensive", color="blue"]\n1 [label=<<table border="0" cellspacing="0"> <tr><td port="port1" border="1" bgcolor="blue"><b> prediction: Car </b></td></tr><tr><td port="port0" border="1" align="left"> prob(Bus): 0.0% </td></tr><tr><td port="port1" border="1" align="left"> prob(Car): 100.0% </td></tr><tr><td port="port2" border="1" align="left"> prob(Train): 0.0% </td></tr></table>>, shape="circle", style="filled"]\n2 [label="\\"cost\\"", shape="box", style="filled"]\n2 -> 3 [label="= Cheap", color="blue"]\n2 -> 4 [label="!= Cheap", color="blue"]\n3 [label="\\"Gender\\"", shape="box", style="filled"]\n3 -> 5 [label="= Female", color="blue"]\n3 -> 6 [label="!= Female", color="blue"]\n4 [label=<<table border="0" cellspacing="0"> <tr><td port="port1" border="1" bgcolor="green"><b> prediction: Train </b></td></tr><tr><td port="port0" border="1" align="left"> prob(Bus): 0.0% </td></tr><tr><td port="port1" border="1" align="left"> prob(Car): 0.0% </td></tr><tr><td port="port2" border="1" align="left"> prob(Train): 100.0% </td></tr></table>>, shape="circle", style="filled"]\n5 [label="\\"owned cars\\"", shape="box", style="filled"]\n5 -> 7 [label="<= 0.05", color="blue"]\n5 -> 8 [label="> 0.05", color="blue"]\n6 [label=<<table border="0" cellspacing="0"> <tr><td port="port1" border="1" bgcolor="red"><b> prediction: Bus </b></td></tr><tr><td port="port0" border="1" align="left"> prob(Bus): 100.0% </td></tr><tr><td port="port1" border="1" align="left"> prob(Car): 0.0% </td></tr><tr><td port="port2" border="1" align="left"> prob(Train): 0.0% </td></tr></table>>, shape="circle", style="filled"]\n7 [label=<<table border="0" cellspacing="0"> <tr><td port="port1" border="1" bgcolor="red"><b> prediction: Bus </b></td></tr><tr><td port="port0" border="1" align="left"> prob(Bus): 100.0% </td></tr><tr><td port="port1" border="1" align="left"> prob(Car): 0.0% </td></tr><tr><td port="port2" border="1" align="left"> prob(Train): 0.0% </td></tr></table>>, shape="circle", style="filled"]\n8 [label=<<table border="0" cellspacing="0"> <tr><td port="port1" border="1" bgcolor="green"><b> prediction: Train </b></td></tr><tr><td port="port0" border="1" align="left"> prob(Bus): 0.0% </td></tr><tr><td port="port1" border="1" align="left"> prob(Car): 0.0% </td></tr><tr><td port="port2" border="1" align="left"> prob(Train): 100.0% </td></tr></table>>, shape="circle", style="filled"]\n}'
