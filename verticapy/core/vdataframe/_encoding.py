...
class vDFEncode(vDFFill):
    ...
    def case_when(self, name: str, *args) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.decode` : User Defined Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.eval` : Evaluates an expression.
        """
    ...
    def one_hot_encode(
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.decode` : User Defined Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.label_encode` : Label Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.mean_encode` : Mean Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.discretize` : Discretization.
        """
...
class vDCEncode(vDCFill):
    ...
    def cut(
        ...
        Let's discretize "age" using the ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.cut` method.
        ...
        Let's discretize "fare" using the ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.cut` method.
        ...
        Let's discretize "parch" using the ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.cut` method.
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.label_encode` : Label Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.mean_encode` : Mean Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.one_hot_encode` : One Hot Encoding.
        """
    ...
    def decode(self, *args) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.case_when` : Conditional Statement.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.eval` : Evaluates an expression.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.label_encode` : Label Encoding.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.mean_encode` : Mean Encoding.
        """
