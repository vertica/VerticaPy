...
class vDFCorr(vDFEncode):
    ...
    def corr(
        ...
        **style_kwargs
        ...
        .. seealso::
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.corr_pvalue` : Computes correlation and its p-value.
        """
    ...
    def corr_pvalue(
        ...
        .. seealso::
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.corr` : Computes the correlation matrix.
        """
        method = str(method).lower()
    ...
    def acf(
        ...
        **style_kwargs
        ...
        .. seealso::
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.pacf` : Computes the partial autocorrelations.
        """
        method = str(method).lower()
    ...
    def pacf(
        ...
        **style_kwargs
        ...
        .. seealso::
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.acf` : Computes the autocorrelations.
        """
    ...
    def iv_woe(
        ...
        **style_kwargs
        ...
        .. seealso::
            | ``vDataColumn.``:py:meth:`~verticapy.vDataColumn.iv_woe` : Computes IV / WOE table.
        """
        columns = format_type(columns, dtype=list)
...
class vDCCorr(vDCEncode):
    ...
    def iv_woe(self, y: str, nbins: int = 10) -> TableSample:
        ...
        .. seealso::
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.iv_woe` : Draw IV Plot.
        """
