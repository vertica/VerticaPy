...
class vDFFilter(vDFAgg):
    ...
    def at_time(self, ts: str, time: TimeInterval) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.balance` : Balances the vDataFrame.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.between` : Filters between two conditions.
        """
    ...
    def between(
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.balance` : Balances the vDataFrame.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.at_time` : Filters the vDataFrame at a specific time.
        """
    ...
    def drop(self, columns: Optional[SQLColumns] = None) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.balance` : Balances the vDataFrame.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.drop_duplicates` : Drops the vDataFrame duplicates.
        """
    ...
    def drop_duplicates(self, columns: Optional[SQLColumns] = None) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.balance` : Balances the vDataFrame.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.drop` : Drops the vDataFrame input columns.
        """
        columns = format_type(columns, dtype=list)
    ...
    def last(self, ts: str, offset: str) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.first` : Filters the vDataFrame by only keeping the first records.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.at_time` : Filters the vDataFrame at a specific time.
        """
        ts = self.format_colnames(ts)
    ...
    def sample(
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.balance` : Balances the vDataFrame.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.isin` : Checks whether specific records are in the vDataFrame.
        """
        if x == 1:
            return self.copy()
...
class vDCFilter(vDCAgg):
    ...
    def drop(self, add_history: bool = True) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataColumn.``:py:meth:`~verticapy.vDataColumn.drop` : Drops the input vDataColumn.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.drop_duplicates` : Drops the vDataFrame duplicates.
        """
        try:
            parent = self._parent
    ...
    def dropna(self) -> "vDataFrame":
        ...
        .. seealso::
            ...
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.dropna` : Drops the vDataFrame missing values.
            | ``vDataFrame.``:py:meth:`~verticapy.vDataFrame.drop` : Drops the vDataFrame input columns.
        """
