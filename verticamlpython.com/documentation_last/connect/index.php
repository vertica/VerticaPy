    ...
    <body>
      ...
      <div id="content">
        ...
        <table class="functions_description">
          ...
          <tr> <td><a href="available_auto_connection/index.php">available_auto_connection</a></td> <td>Displays all the available auto connections.</td> </tr>
          ...
          <tr> <td><a href="read_auto_connect/index.php">read_auto_connect</a></td> <td>Automatically creates a connection using the one created when using the function new_auto_connection.</td> </tr>
