...
<h1 id="vDataFrame.catcol">vDataFrame.catcol<a class="anchor-link" href="#vDataFrame.catcol">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">catcol</span><span class="p">(</span><span class="n">max_cardinality</span><span class="p">:</span> <span class="nb">int</span> <span class="o">=</span> <span class="mi">12</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Returns the vDataFrame categorical vcolumns.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Returns">Returns<a class="anchor-link" href="#Returns">&#182;</a></h3><p><b>List</b> : List of the categorical vcolumns names.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">titanic</span><span class="o">.</span><span class="n">catcol</span><span class="p">(</span><span class="n">max_cardinality</span> <span class="o">=</span> <span class="mi">10</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># parch and sibsp are not considered because their cardinalities are greater than 6</span>
<span class="n">titanic</span><span class="o">.</span><span class="n">catcol</span><span class="p">(</span><span class="n">max_cardinality</span> <span class="o">=</span> <span class="mi">6</span><span class="p">)</span>
</pre></div>
