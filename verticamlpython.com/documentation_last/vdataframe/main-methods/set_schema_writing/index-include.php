...
<h1 id="vDataFrame.set_schema_writing">vDataFrame.set_schema_writing<a class="anchor-link" href="#vDataFrame.set_schema_writing">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">set_schema_writing</span><span class="p">(</span><span class="n">schema_writing</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Sets a new writing schema, this schema will be used to create temporary table if it is necessary.</p>
<h3 id="Parameters">Parameters<a class="anchor-link" href="#Parameters">&#182;</a></h3><table id="parameters">
    <tr> <th>Name</th> <th>Type</th> <th>Optional</th> <th>Description</th> </tr>
    <tr> <td><div class="param_name">schema_writing</div></td> <td><div class="type">str</div></td> <td><div class = "no">&#10060;</div></td> <td>New schema writing name.</td> </tr>
</table>
</div>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Some methods need to create a temporary table to get the new columns</span>
<span class="c1"># and data types. This temporary table will now use the schema</span>
<span class="c1"># my_schema to do the operations</span>
<span class="n">titanic</span><span class="o">.</span><span class="n">set_schema_writing</span><span class="p">(</span><span class="s2">&quot;my_schema&quot;</span><span class="p">)</span>
</pre></div>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    <tr><td><a href="../set_cursor">vDataFrame.set_cursor</a></td> <td> Sets a new DB cursor.</td></tr>
