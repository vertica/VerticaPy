...
<h1 id="vDataFrame.to_csv">vDataFrame.to_csv<a class="anchor-link" href="#vDataFrame.to_csv">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">to_csv</span><span class="p">(</span><span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span>
                  ...
                  <span class="n">new_header</span><span class="p">:</span> <span class="nb">list</span> <span class="o">=</span> <span class="p">[],</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Creates a CSV file of the current vDataFrame relation.</p>
<h3 id="Parameters">Parameters<a class="anchor-link" href="#Parameters">&#182;</a></h3><table id="parameters">
    <tr> <th>Name</th> <th>Type</th> <th>Optional</th> <th>Description</th> </tr>
    <tr> <td><div class="param_name">name</div></td> <td><div class="type">str</div></td> <td><div class = "no">&#10060;</div></td> <td>Name of the CSV file. Be careful: if a CSV file with the same name exists, it will over-write it.</td> </tr>
    <tr> <td><div class="param_name">path</div></td> <td><div class="type">str</div></td> <td><div class = "yes">&#10003;</div></td> <td>Absolute path where the CSV file will be created.</td> </tr>
    ...
    <tr> <td><div class="param_name">quotechar</div></td> <td><div class="type">str</div></td> <td><div class = "yes">&#10003;</div></td> <td>Char which will enclose the str values.</td> </tr>
    ...
    <tr> <td><div class="param_name">header</div></td> <td><div class="type">bool</div></td> <td><div class = "yes">&#10003;</div></td> <td>If set to False, no header will be written in the CSV file.</td> </tr>
    <tr> <td><div class="param_name">new_header</div></td> <td><div class="type">list</div></td> <td><div class = "yes">&#10003;</div></td> <td>List of columns used to replace vcolumns name in the CSV.</td> </tr>
    ...
    <tr> <td><div class="param_name">limit</div></td> <td><div class="type">int</div></td> <td><div class = "yes">&#10003;</div></td> <td>If greater than 0, the maximum number of elements to write at the same time in the CSV file. It can be used to minimize memory impacts. Be sure to keep the same order to avoid unexpected results.</td> </tr>
</table>
</div>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Creating the CSV file of the current vDataFrame</span>
<span class="n">titanic</span><span class="o">.</span><span class="n">to_csv</span><span class="p">(</span><span class="n">name</span> <span class="o">=</span> <span class="s2">&quot;titanic&quot;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Reading the CSV file</span>
<span class="n">file</span> <span class="o">=</span> <span class="nb">open</span><span class="p">(</span><span class="s2">&quot;titanic.csv&quot;</span><span class="p">,</span> <span class="s2">&quot;r&quot;</span><span class="p">)</span> 
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;header:&quot;</span><span class="p">)</span>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    ...
    <tr><td><a href="../to_json">vDataFrame.to_json</a></td> <td>Creates a JSON file of the current vDataFrame relation.</td></tr>
</table>
</div>
</div>
</div>