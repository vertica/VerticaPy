...
<h1 id="vDataFrame.to_vdf">vDataFrame.to_vdf<a class="anchor-link" href="#vDataFrame.to_vdf">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">to_vdf</span><span class="p">(</span><span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Saves the vDataFrame to a .vdf text file. The saving can be loaded using the 'read_vdf' function.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Creating the VDF file of the current vDataFrame</span>
<span class="n">titanic</span><span class="o">.</span><span class="n">to_vdf</span><span class="p">(</span><span class="n">name</span> <span class="o">=</span> <span class="s2">&quot;titanic&quot;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Reading the VDF file</span>
<span class="n">file</span> <span class="o">=</span> <span class="nb">open</span><span class="p">(</span><span class="s2">&quot;titanic.vdf&quot;</span><span class="p">,</span> <span class="s2">&quot;r&quot;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;It will save everything needed to recreate the vDataFrame:</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s1">&#39;&#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">file</span><span class="o">.</span><span class="n">readlines</span><span class="p">()))</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>It will save everything needed to recreate the vDataFrame:
...
vdf_save._VERTICA_ML_PYTHON_VARIABLES_[&#34;time_on&#34;] = False
vdf_save._VERTICA_ML_PYTHON_VARIABLES_[&#34;order_by&#34;] = {}
...
</pre>
</div>
</div>
