...
<h1 id="vDataFrame.sql_on_off">vDataFrame.sql_on_off<a class="anchor-link" href="#vDataFrame.sql_on_off">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">sql_on_off</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Displays each query generated by the vDataFrame.</p>
...
<div class="output_html rendered_html output_subarea ">
 &emsp;  SELECT <br> &emsp;  &emsp;  SUMMARIZE_NUMCOL("survived", "sibsp", "fare", "body", "pclass", "age", "parch") OVER () &emsp; <br> &emsp;  FROM <br> "public"."titanic"
</div>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    <tr><td><a href="../time_on_off">vDataFrame.time_on_off</a></td> <td>Displays the time took by each query.</td></tr>
</table>
</div>
</div>
</div>