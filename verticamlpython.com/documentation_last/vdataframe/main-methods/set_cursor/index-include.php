...
<h1 id="vDataFrame.set_cursor">vDataFrame.set_cursor<a class="anchor-link" href="#vDataFrame.set_cursor">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="o">.</span><span class="n">set_cursor</span><span class="p">(</span><span class="n">cursor</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Sets a new DB cursor. It can be very usefull if the connection to the DB is lost.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Creating a new cursor</span>
...
<span class="c1"># Set a new cursor in case of failure</span>
<span class="n">titanic</span><span class="o">.</span><span class="n">set_cursor</span><span class="p">(</span><span class="n">cur</span><span class="p">)</span>
</pre></div>
