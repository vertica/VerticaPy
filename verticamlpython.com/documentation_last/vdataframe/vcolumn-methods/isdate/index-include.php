...
<h1 id="vDataFrame[].isdate">vDataFrame[].isdate<a class="anchor-link" href="#vDataFrame[].isdate">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="p">[]</span><span class="o">.</span><span class="n">isdate</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Returns True if the vcolumn category is date, False otherwise.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Returns">Returns<a class="anchor-link" href="#Returns">&#182;</a></h3><p><b>bool</b> : True if the vcolumn category is date.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">amazon</span><span class="p">[</span><span class="s2">&quot;date&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">isdate</span><span class="p">()</span>
</pre></div>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    <tr><td><a href="../isnum">vDataFrame[].isnum</a></td> <td>Returns True if the vcolumn is numerical.</td></tr>
</table>
</div>
</div>
</div>