...
<h1 id="vDataFrame[].nsmallest">vDataFrame[].nsmallest<a class="anchor-link" href="#vDataFrame[].nsmallest">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="p">[]</span><span class="o">.</span><span class="n">nsmallest</span><span class="p">(</span><span class="n">n</span><span class="p">:</span> <span class="nb">int</span> <span class="o">=</span> <span class="mi">10</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Returns the n smallest vcolumn elements.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">market</span><span class="p">[</span><span class="s2">&quot;Price&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">nsmallest</span><span class="p">(</span><span class="n">n</span> <span class="o">=</span> <span class="mi">5</span><span class="p">)</span>
</pre></div>
...
<div class="output_html rendered_html output_subarea ">
<table style="border-collapse: collapse; border: 2px solid white"><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b></b></td><td style="font-size:1.02em;background-color:#263133;color:white"><b>Name</b></td><td style="font-size:1.02em;background-color:#263133;color:white"><b>Form</b></td><td style="font-size:1.02em;background-color:#263133;color:white"><b>Price</b></td></tr><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b>0</b></td><td style="border: 1px solid white;">Watermelon</td><td style="border: 1px solid white;">Fresh</td><td style="border: 1px solid white;">0.3166387792</td></tr><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b>1</b></td><td style="border: 1px solid white;">Watermelon</td><td style="border: 1px solid white;">Fresh</td><td style="border: 1px solid white;">0.333412035323</td></tr><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b>2</b></td><td style="border: 1px solid white;">Apples</td><td style="border: 1px solid white;">Frozen</td><td style="border: 1px solid white;">0.5104657455</td></tr><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b>3</b></td><td style="border: 1px solid white;">Cantaloupe</td><td style="border: 1px solid white;">Fresh</td><td style="border: 1px solid white;">0.520793672</td></tr><tr ><td style="font-size:1.02em;background-color:#263133;color:white"><b>4</b></td><td style="border: 1px solid white;">Cantaloupe</td><td style="border: 1px solid white;">Fresh</td><td style="border: 1px solid white;">0.535873776106</td></tr></table>
</div>
...
<pre>&lt;object&gt;  Name: nsmallest, Number of rows: 5, Number of columns: 3</pre>
</div>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    <tr><td><a href="../nlargest/index.php">vDataFrame[].nlargest</a></td> <td>Returns the n largest vcolumn elements.</td></tr>
</table>
</div>
</div>
</div>