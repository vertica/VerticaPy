...
<h1 id="vDataFrame[].str_contains">vDataFrame[].str_contains<a class="anchor-link" href="#vDataFrame[].str_contains">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">vDataFrame</span><span class="p">[]</span><span class="o">.</span><span class="n">str_contains</span><span class="p">(</span><span class="n">pat</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Verifies if the regular expression is in each of the vcolumn records. The vcolumn will be transformed.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">titanic</span><span class="p">[</span><span class="s2">&quot;name&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">str_contains</span><span class="p">(</span><span class="n">pat</span> <span class="o">=</span> <span class="s2">&quot; ([A-Za-z])+\.&quot;</span><span class="p">)</span>
</pre></div>
...
<pre>&lt;object&gt;  Name: name, Number of rows: 1234, dtype: boolean</pre>
</div>
...
<h3 id="See-Also">See Also<a class="anchor-link" href="#See-Also">&#182;</a></h3><table id="seealso">
    ...
    <tr><td><a href="../extract">vDataFrame[].extract</a></td> <td> Extracts the regular expression in each record of the vcolumn.</td></tr>
