    ...
    <body>
      ...
      <div id="content">
        ...
        <table class="functions_description">
          ...
          <tr> <td><a href="best_k/index.php">best_k</td> <td>Finds the k-means k based on a score.</td> </tr>
          <tr> <td><a href="cross_validate/index.php">cross_validate</td> <td>Computes the k-fold cross-validation of an estimator.</td> </tr>
          <tr> <td><a href="train_test_split/index.php">train_test_split</td> <td>Creates a temporary table and two views which can be used to evaluate a model.</td> </tr>
        </table>
