...
<h1 id="median_absolute_error">median_absolute_error<a class="anchor-link" href="#median_absolute_error">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">median_absolute_error</span><span class="p">(</span><span class="n">y_true</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> 
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Computes the Median Absolute Error.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="kn">from</span> <span class="nn">vertica_ml_python.learn.metrics</span> <span class="k">import</span> <span class="n">median_absolute_error</span>
<span class="n">median_absolute_error</span><span class="p">(</span><span class="s2">&quot;y_true&quot;</span><span class="p">,</span> <span class="s2">&quot;y_score&quot;</span><span class="p">,</span> <span class="s2">&quot;regression_example&quot;</span><span class="p">)</span>
</pre></div>
