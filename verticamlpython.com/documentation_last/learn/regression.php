    ...
    <body>
      ...
      <div id="content">
        ...
        <table class="functions_description">
          ...
          <tr> <td><a href="RandomForestRegressor/index.php">RandomForestRegressor</td> <td>Creates a RandomForestRegressor object by using the Vertica Highly Distributed and Scalable Random Forest on the data.</td> </tr>
          <tr> <td><a href="Ridge/index.php">Ridge</td> <td>Creates a Ridge object by using the Vertica Highly Distributed and Scalable Linear Regression on the data.</td> </tr>
        </table>
