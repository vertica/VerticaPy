...
<h1 id="regressor.fit">regressor.fit<a class="anchor-link" href="#regressor.fit">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">regressor</span><span class="o">.</span><span class="n">fit</span><span class="p">(</span><span class="n">input_relation</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span>
...
call_string
===========
SELECT rf_regressor(&#39;public.RF_winequality&#39;, &#39;public.winequality&#39;, &#39;&#34;quality&#34;&#39;, &#39;&#34;alcohol&#34;, &#34;fixed_acidity&#34;&#39; USING PARAMETERS exclude_columns=&#39;&#39;, ntree=20, mtry=1, sampling_size=0.7, max_depth=3, max_breadth=32, min_leaf_size=5, min_info_gain=0, nbins=32);
